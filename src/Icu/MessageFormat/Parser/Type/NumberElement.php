...
/**
 * @template-extends AbstractSimpleFormatElement<NumberSkeleton>
 */
final class NumberElement extends AbstractSimpleFormatElement
{
    /**
     * @param string | NumberSkeleton | null $style
     */
