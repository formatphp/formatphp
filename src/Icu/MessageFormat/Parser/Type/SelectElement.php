...
{
    /**
     * @var array<string, PluralOrSelectOption>
     */
    public array $options = [];

    /**
     * @param array<string, PluralOrSelectOption> $options
     */
    public function __construct(string $value, array $options, Location $location)
    {
